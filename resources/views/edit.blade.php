...
@section('main')
     ...
     <form method="post" action="{{ route('crud.update', $data->id) }}" enctype="multipart/form-data">
      ...
      <br />
      <div class="form-group">
       <label class="col-md-4 text-right">Zipcode</label>
       <div class="col-md-8">
        <input type="text" name="zipcod" value="{{ $data->zipcod }}" class="form-control input-lg" />
       </div>
      </div>
      ...
      <br />
      <div class="form-group">
       <label class="col-md-4 text-right">USER EMAIL</label>
       <div class="col-md-8">
